...
4. **Room-Level Zone Classification**: The zone classification applies to the ENTIRE ROOM, not areas within it. The source room (fire origin) = Burn Zone. Adjacent rooms = Near-Field. Rooms separated by multiple rooms/corridors = Far-Field. Use fire origin metadata to determine zone. Do NOT classify sub-areas within a single room as different zones.
